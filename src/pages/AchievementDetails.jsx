  ...
  return (
    <div className={`mt-16 min-h-screen flex flex-col items-center justify-center p-8 transition-colors duration-300 ${
      ...
      <div className="w-full max-w-4xl bg-gradient-to-r from-green-400 to-gray-500 text-white p-6 rounded-t-3xl text-center shadow-lg">
        ...
        <p className="mt-2 text-lg opacity-90">Learn more about this project</p>
      </div>

      <div className={`max-w-4xl w-full p-6 rounded-b-3xl shadow-2xl border transition-all ${
        theme === "dark"
          ? "bg-gray-950 border-green-500 shadow-green-500/50"
          : "bg-gray-400 border-green-700 shadow-green-700/50"
      }`}>
